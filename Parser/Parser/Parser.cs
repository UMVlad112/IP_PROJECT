 ...
 *  Description: Clasa cu metode statice prin care se realizeaza          *
 *               lucrul cu fisiere.                                       *
 *                                                                        *
...
namespace ProiectIP
{
    ...
    public class Parser
    {
        ...
        /// </returns>
        public static string returnScore(int punctaj)
        {
            string toInsert = "";
            for (int i = 0; i < 10; i++)
            {
        ...
        /// Noul istoric al utilizatorului curent
        /// </returns>
        public static string returnScore(string istoric, int punctaj)
        {
            string toInsert = "";
